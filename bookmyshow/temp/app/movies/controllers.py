...
'''@mod_movies.route('/movies',methods=['GET'])
def show():
	if 'user_id' in session:
		return render_template('movies.html',state="LOGOUT",url="/logout")
	else:
		return render_template('movies.html',state="SIGN IN",url="/login")
'''
